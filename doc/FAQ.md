...
Even with high resolution (1024x1024 and beyound) mipmapping can still smear textures down when sampling under grazing angles. With default settings the GPU ends up sampling from a lower-resolution mip level, which reduces aliasing but also causes loss of detail.
