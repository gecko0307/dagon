...
Scaling is an XYZ vector where 1.0 means identity scale, and 0.0 means infinitesimal scale. Dagon supports non-uniform scaling, but it may interfere with geometric logic in unexpected ways, and using it in 3D graphics is generally discouraged.
