...
- **UI**
  - `dagon.ui.widget`: a simple built-in UI engine. Currently four widgets are available: `Window` (`dagon.ui.widgets.window`), `Label` (`dagon.ui.widgets.label`), `TextView` (`dagon.ui.widgets.textview`), `TextInput` (`dagon.ui.widgets.textinput`)
- **Assets**
