...
* Texture compression support: S3TC (DXTn), RGTC, BPTC, [Basis Universal](https://github.com/BinomialLLC/basis_universal). Built-in DXT1, DXT5, RGTC (BC4) and BPTC compressors. DDS exporter
...
* UDP networking based on [ENet](http://enet.bespin.org/). Asynchronous UDP client that works via the message broker.
