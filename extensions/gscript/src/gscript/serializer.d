...
Array!GsInstruction loadBytecode(ubyte[] code)
{
    Array!GsInstruction instructions;
    
    size_t i = 0;

    if (code.length < 4 + int.sizeof)
        throw new Exception("Invalid or corrupted GSIR file");
    ...
    if (ver != GSIR_VERSION)
        throw new Exception("Unsupported GSIR version");
    ...
    while (i < code.length)
    {
        ...
        instructions.append(GsInstruction(type, operand));
    }
