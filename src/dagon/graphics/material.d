...
class Material: Owner
{
    ...
    deprecated("use baseColorTexture instead") void diffuse(Texture t) @property
    {
        baseColorTexture = t;
    }
    
    deprecated("use baseColorFactor instead") void diffuse(Color4f c) @property
    {
        baseColorFactor = c;
    }
    
    deprecated("use roughnessMetallicTexture instead") void roughnessMetallic(Texture t) @property
    {
        roughnessMetallicTexture = t;
    }
    
    deprecated("use roughnessFactor instead") void roughness(float r) @property
    {
        roughnessFactor = r;
    }
    
    deprecated("use metallicFactor instead") void metallic(float m) @property
    {
        metallicFactor = m;
    }
    
    deprecated("use emissionTexture instead") void emission(Texture t) @property
    {
        emissionTexture = t;
    }
    
    deprecated("use emissionFactor instead") void emission(Color4f c) @property
    {
        emissionFactor = c;
    }
    
    deprecated("use emissionEnergy instead") void energy(float e) @property
    {
        emissionEnergy = e;
    }
    
    deprecated("use normalTexture instead") void normal(Texture t) @property
    {
        normalTexture = t;
    }
    
    deprecated("use normalFactor instead") void normal(Vector3f n) @property
    {
        normalFactor = n;
    }
    
    deprecated("use heightTexture instead") void height(Texture t) @property
    {
        heightTexture = t;
    }
    
    deprecated("use normalFactor instead") void height(float h) @property
    {
        heightFactor = h;
    }
    
    deprecated("use opacity instead") void transparency(float t) @property
    {
        opacity = t;
    }
    
    deprecated("use alphaTestThreshold instead") void clipThreshold(float t) @property
    {
        alphaTestThreshold = t;
    }
    
    deprecated("use blendMode instead") void blending(int b) @property
    {
        blendMode = b;
    }
    
    deprecated("use parallaxMode instead") void parallax(int p) @property
    {
        parallaxMode = p;
    }
    
    deprecated("use useShadows instead") void shadowsEnabled(bool m) @property
    {
        useShadows = m;
    }
    
    deprecated("use useFog instead") void fogEnabled(bool m) @property
    {
        useFog = m;
    }
    
    deprecated("use useCulling instead") void culling(bool m) @property
    {
        useCulling = m;
    }
}
