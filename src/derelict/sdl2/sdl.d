...
class DerelictSDL2Loader : SharedLibLoader
{
    ...
    this()
    {
        super(
            "sdl2.dll",
            "libSDL2.so, libSDL2.so.0, libSDL2-2.0.so, libSDL2-2.0.so.0",
            "/usr/local/lib/libSDL2.dylib, ../Frameworks/SDL2.framework/SDL2, /Library/Frameworks/SDL2.framework/SDL2, /System/Library/Frameworks/SDL2.framework/SDL2"
        );
    }
...
DerelictSDL2Loader DerelictSDL2;
